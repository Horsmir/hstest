...
void MainWindow::testLoaded()
{
	...
	setWindowTitle("HsTester-" + testManager->getTestName());
...
void MainWindow::on_actionAbout_triggered()
{
	...
	str1 = trUtf8("<h2>Hs Tester 0.1</h2><p>Программа <b>Hs Tester</b> предназначена для тестирования учеников, студентов и сотрудников учреждений средствами компьютерных сетей.</p><p>Copyright &copy;  2012 Роман Браун</p>");
